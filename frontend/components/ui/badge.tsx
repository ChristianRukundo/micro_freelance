  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-caption font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        secondary: "border-transparent bg-neutral-100 hover:bg-neutral-200", // Custom neutral-based secondary
        destructive:
        ...
        "status-success":
          "border-transparent bg-success-500/10 text-success-600",
        "status-warning":
          "border-transparent bg-warning-500/10 text-warning-600",
