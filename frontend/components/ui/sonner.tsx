  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            "group toast group-[.toaster]:bg-background group-[.toaster]:text-foreground group-[.toaster]:border-border group-[.toaster]:shadow-medium dark:shadow-medium-dark group-[.toaster]:rounded-xl", // Custom shadow-medium dark:shadow-medium-dark, rounded-xl
