...
export function EarningsChart({ data, title = 'Monthly Earnings Overview', description = 'Your earnings performance over the last few months.' }: EarningsChartProps) {
  return (
    <motion.div
    ...
    >
      <Card className="shadow-medium border-neutral-200">
        <CardHeader>
          <CardTitle className="text-h3 font-bold text-neutral-800">{title}</CardTitle>
          <CardDescription className="text-body-md text-neutral-600">{description}</CardDescription>
        </CardHeader>
        <CardContent>
