      ...
      <Card className="w-full max-w-md shadow-hard border-neutral-200">
        ...
        <CardContent>
          ...
          <p className="text-center text-body-sm text-neutral-600">
            ...
            <Link href="/login" className="text-primary-500 font-medium hover:underline flex items-center justify-center mt-2 cursor-pointer" aria-label="Go to login page">
