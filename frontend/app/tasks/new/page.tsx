...
export default function NewTaskPage() {
  return (
    <div className="container py-8">
      <Card className="w-full shadow-medium border-neutral-200">
        <CardHeader className="pb-4">
          <CardTitle className="text-h2 font-bold text-neutral-800">Post a New Project</CardTitle>
          <CardDescription className="text-body-md text-neutral-600">
            Describe your project in detail, set your budget, and attach any relevant files.
          </CardDescription>
        </CardHeader>
        <CardContent>
