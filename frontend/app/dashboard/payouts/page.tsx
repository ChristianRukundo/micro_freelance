...
export default function PayoutsPage() {
  ...
  useEffect(() => {
    ...
    if (errorStripeAccountStatus) {
      toast.error(
        "Failed to load Stripe account status. Please try refreshing or connecting again."
      );
    }
    refetchStripeAccountStatus();
          ...
          {isLoadingStripeAccountStatus ? (
            ...
            <div className="flex flex-col space-y-4">
              ...
              <Button
                ...
                className="w-fit shadow-primary dark:shadow-primary-dark group"
              >
                {isCreatingStripeConnectAccount ? (
                  <>
                    <LoadingSpinner
        ...
        <Card className="shadow-medium dark:shadow-medium-dark border-neutral-200">
          <CardContent className="p-6">
            ...
            <Button
              variant="link"
              className="mt-4"
              onClick={() => toast.info("Payout history coming soon!")}
            >
              View All Payouts
            </Button>
          </CardContent>
