...
export default async function ProjectWorkspacePage({ params }: ProjectWorkspacePageProps) {
  ...
  return (
    <div className="flex flex-col space-y-8 py-8">
      <h1 className="text-display-md font-extrabold text-neutral-800">Project Workspace</h1>
      <p className="text-body-md text-neutral-600">
        Manage "{initialTask.title}" - track progress, communicate, and handle payments.
      </p>
      ...
      <HydrationBoundary state={dehydrate(queryClient)}>
        <ErrorBoundary fallback={
          <Alert variant="destructive">
            ...
            <AlertDescription>
              There was an issue displaying the project overview. Please try refreshing.
            </AlertDescription>
          </Alert>
        }>
